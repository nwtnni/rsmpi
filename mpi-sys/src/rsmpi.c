...
const MPI_Datatype RSMPI_CHAR = MPI_CHAR;
const MPI_Datatype RSMPI_SHORT = MPI_SHORT;
const MPI_Datatype RSMPI_INT = MPI_INT;
const MPI_Datatype RSMPI_LONG = MPI_LONG;
...
const MPI_Datatype RSMPI_BYTE = MPI_BYTE;
const MPI_Datatype RSMPI_UNSIGNED_CHAR = MPI_UNSIGNED_CHAR;
const MPI_Datatype RSMPI_UNSIGNED_SHORT = MPI_UNSIGNED_SHORT;
const MPI_Datatype RSMPI_UNSIGNED = MPI_UNSIGNED;
const MPI_Datatype RSMPI_UNSIGNED_LONG = MPI_UNSIGNED_LONG;
...
const void* RSMPI_IN_PLACE = MPI_IN_PLACE;
